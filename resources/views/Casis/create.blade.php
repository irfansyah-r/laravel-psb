    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link" style="color: black;"  id="form3-tab" data-toggle="tab" href="#form3" role="tab" aria-controls="form3">Data Orang Tua&nbsp
                ...
                <li class="nav-item">
                    <a class="nav-link" style="color: black;"  id="form4-tab" data-toggle="tab" href="#form4" role="tab" aria-controls="form3">Lain-lain&nbsp
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="card-body">
            <div class="tab-content">
                <div class="tab-pane fade show active" id="form1" role="tabpanel">
                	<form class="needs-validation" method="POST" action="{{ url('simpan') }}">
                        @include('Casis/form')
                </div>
            </div>
        </div>
